    ...
    <header class="header py-md-2">
        <div class="navbar navbar-expand-lg absolute-top pt-0">
          <div class="container align-items-md-center align-items-start justify-content-md-end justify-content-start pt-md-2 pt-3">
            <button class="navbar-toggler bg-light text-secondary order-1 order-sm-0 order-md-1 ms-auto" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasHomeMenu" aria-controls="offcanvasHomeMenu" aria-expanded="false" aria-label="Переключатель навигации"><span class="navbar-toggler-icon"></span></button>
            <form class="d-flex align-items-start justify-content-lg-end flex-wrap flex-lg-grow-0 w-50 flex-grow-1 order-0 order-lg-1 gap-md-3 gap-3">
              <!--<button class="btn btn-primary rounded-pill btn-sm" type="button">
              ...
              <div class="phone"><a href="tel:+79261605204">
                  ...
                  </svg><span class="d-md-inline-block d-none">+7 926 160 5204</span></a></div>
              <div class="email email-mobile"><a href="#">
            ...
            <div class="offcanvas offcanvas-start text-bg-dark" id="offcanvasHomeMenu" aria-labelledby="offcanvasHomeLabel">
              <div class="offcanvas-header">
                <div class="offcanvas-title"> <a class="logo" href="#"><img src="https://dev.x1team.ru/wp-content/uploads/2023/01/logo-2.png" alt="logo"></a></div>
              ...
              <div class="offcanvas-body">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 mt-lg-0 mt-3">
                    ...
                    <li class="nav-item"><a class="nav-link" href="/unity/football">Unity</a></li>
                    <?php
                      if( ! $current_user->exists() ){
                        ?>
                ...
                <div class="phone d-md-none d-inline-block"><a href="tel:+79261605204">
                    <svg class="bi bi-telephone me-1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                      <path d="M3.654 1.328a.678.678 0 0 0-1.015-.063L1.605 2.3c-.483.484-.661 1.169-.45 1.77a17.568 17.568 0 0 0 4.168 6.608 17.569 17.569 0 0 0 6.608 4.168c.601.211 1.286.033 1.77-.45l1.034-1.034a.678.678 0 0 0-.063-1.015l-2.307-1.794a.678.678 0 0 0-.58-.122l-2.19.547a1.745 1.745 0 0 1-1.657-.459L5.482 8.062a1.745 1.745 0 0 1-.46-1.657l.548-2.19a.678.678 0 0 0-.122-.58L3.654 1.328zM1.884.511a1.745 1.745 0 0 1 2.612.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.678.678 0 0 0 .178.643l2.457 2.457a.678.678 0 0 0 .644.178l2.189-.547a1.745 1.745 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.634 18.634 0 0 1-7.01-4.42 18.634 18.634 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877L1.885.511z"></path>
                    </svg><span>+7 926 160 5204</span></a></div>
              </div>
            </div>
          </div>
        </div>
