...
<?php wp_body_open(); ?>
    ...
    <header class="header py-md-2 pt-lg-3">
        <div class="navbar navbar-expand-lg absolute-top py-0 rounded px-0">
          <div class="container-sm container-fluid align-items-center justify-content-md-end justify-content-start px-xxl-3 px-md-0 py-md-0 py-2 bg-white mb-md-2"><a class="navbar-brand order-0 p-0 me-md-4 me-0" href="https://x1team.ru"><img class="logo" src="https://x1team.ru/wp-content/uploads/2023/01/logo.png" alt="logo"></a>
            ...
            <div class="offcanvas offcanvas-start text-bg-white" id="offcanvasNavbarMenu" aria-labelledby="offcanvasNavbarLabel">
              ...
              <div class="offcanvas-body">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 mt-lg-0 mt-3">
                  ...
                  <li class="nav-item"><a class="nav-link py-lg-0" href="/unity/football">Unity/Football</a></li>
